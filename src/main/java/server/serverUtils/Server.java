...
public class Server {
    ...
    public void run() throws NullPointerException {
        try {
            //execute(new WrapperForObjects(3333,DescriptionForObject.REG_USER));
    ...
    public void processUser(WrapperForObjects object) {
        try {
            ...
            byte[] result;
            if (object.getDescription() == DescriptionForObject.REG_USER) {
    ...
    public WrapperForObjects readClientRequest() {
        try {
            datagramSocket.setSoTimeout(1000000);
    ...
    public void execute(WrapperForObjects object) {
        if (object.getDescription().equals(DescriptionForObject.COMMAND)) {
