...
public class gui_ru_RU extends ListResourceBundle {
    ...
    private static final Object[][] contents = {
            ...
            {"GroupCommand", "Id элементов, сгруппированных по высоте над уровнем моря: \n{0}"},
            {"Error", "Ошибка"},
            {"GetId", "Введите id:"},
            ...
            {"StringObject", "имя: {0}, X: {1}, Y: {2}, дата создания: {3},"+
                    " площадь территории: {4}, численность населения: {5}, "+
                    "количество метров над уровнем моря: {6}, дата основания: "+
                    "{7}, площадь агломерации: {8}, климат: {9}, возраст губернатора: {10}, создатель: {11}."}
    };
}
